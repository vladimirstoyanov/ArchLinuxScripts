...
# Time related
: ${AGNOSTER_TIME_BG:=green}
: ${AGNOSTER_TIME_FG:=black}
...
prompt_time() {
  # Get the current time in a desired format (e.g., 12:34:56)
  local time_string="%D{%L:%M:%S}"  # %T = HH:MM:SS format
  prompt_segment "$AGNOSTER_TIME_BG" "$AGNOSTER_TIME_FG" "$time_string"
}
